...
import { MdUpload } from "@/components/brain/md-upload";
...
export default function BrainNotesPage() {
  ...
  return (
    <AppShell
      title="Brain · Notes"
      subtitle="Free-form capture — manual notes and ingested .md files"
    >
      <div
        style={{
          maxWidth: 880,
      ...
      >
        ...
        >
          ...
          <input
            ...
            placeholder="Optional title (e.g. 'auth decision')"
            style={inputStyle}
          />
          <textarea
            value={body}
            onChange={(e) => setBody(e.target.value)}
            placeholder="What context should Mesh remember?"
            rows={4}
            style={{
              ...inputStyle,
              fontFamily: "inherit",
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            ...
            >
              .mesh/user/brain.json — injected into every prompt as cached context.
            </span>
          </div>
        </section>
        ...
        <section style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            {!loading && filtered.length === 0 && (
              ...
              >
                {entries.length === 0
                  ? "No notes yet. Upload a .md or write one above."
                  : `No entries of type "${filter}".`}
              </div>
            )}
            {filtered.map((e) => (
